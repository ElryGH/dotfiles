...
run_command "yay -S --sudoloop --noconfirm bash-completion dotnet-runtime dotnet-sdk aspnet-runtime unity jetbrains-toolbox steam discord spotify" "Install Elrys Tools" "yes" "no"
